...
class VisitSlotSerializer(serializers.ModelSerializer):
    ...
    supports_virtual = serializers.ReadOnlyField()
    supports_onsite = serializers.ReadOnlyField()
...
class DirectBookingInquiryCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = DirectBookingInquiry
        fields = ['offered_amount', 'currency', 'proposed_terms', 'buyer_message', 'expires_at']
